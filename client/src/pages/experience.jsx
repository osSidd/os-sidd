...
export default function Experience(){
    ...
    const chipProp = {fontWeight:500, fontSize:16, p:2, backgroundColor:'#b30089', color:'#fefefe', width:'fit-content'}
            ...
            <Grid container>
                ...
                <Grid item xs={12} md={9}>
                    {/* <Box> */}
                        ...
                        {/* list of details */}
                        <List sx={{listStyleType: 'disc', mt:2}}>
                    ...
                    <Box>
                        ...
                        <Stack direction='row' flexWrap='wrap' justifyContent={{xs:'flex-start', md:'flex-start'}} gap={2} mt={2}>
